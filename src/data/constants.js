...
export const experiences = [
  {
    id: 0,
    img: "https://www.airportal.go.kr:450/airworks/0308/photo/logo_file_202012141319080.jpg",
    role: "교내 IT 동아리 ",
    company: "커넥트(Connect)",
...
export const education = [
  {
    ...
    grade: "3.2/4.5",
    desc: "데이터 구조, 알고리즘, 객체 지향 프로그래밍, 데이터베이스 관리 시스템, 운영 체제, 컴퓨터 네트워크 등의 강좌를 수강. 현재 프론트엔드 개발자를 위해 공부중.",
    degree: "컴퓨터소프트웨어공학과 졸업(예정)",
  },
  {
    id: 1,
    img: "https://i.namu.wiki/i/WL6JMrKbhOmqPIoxqog-itjUmooQBwGeH225ZRoIY9imz27OAnPiTcyZWSf0ZoOY4pxn6RyTwk00uHIN0GiJCg.webp",
    school: "건국고등학교",
  ...
  {
    id: 2,
    img: "https://yt3.googleusercontent.com/qv9FWWkglc4PYKoUHJOb65wXMbM_lizUOqIMfsPvj5xLPTCi5UlGSRo9amYmvT00AjTKk-ssPg=s900-c-k-c0x00ffffff-no-rj",
    school: "덕원중학교",
...
export const projects = [
  ...
  },
  {
    ...
    image:
      "https://github.com/YunNamwon/PortFolio/raw/master/src/images/portfolio.jpg",
    tags: ["JavaScript", "React JS", "Styled-Component", "material-UI","Vercel"],
    category: "android app",
    github: "https://github.com/YunNamwon/PortFolio?tab=readme-ov-file",
    webapp: "https://port-folio-mu-seven.vercel.app/",
  },
];
